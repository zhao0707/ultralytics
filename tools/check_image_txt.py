...
def main(args):
    ...
    for file in os.listdir(img_dir):
        ...
        try:
            ...
            img_data = cv2.resize(img_data, (1920, 1280))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_dir', default='/home/pw/code/zsx/yolov11/ultralytics/datasets/PKU-Market-PCB/images/train')
    parser.add_argument('--label_dir', default='/home/pw/code/zsx/yolov11/ultralytics/datasets/PKU-Market-PCB/labels/train')
    parser.add_argument('--class_names', default=['Missing_hole','Mouse_bite','Open_circuit','Short','Spur','Spurious_copper'])
